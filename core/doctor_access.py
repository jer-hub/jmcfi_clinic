...
_HEALTH_FORM_URL_NAME_PREFIXES: tuple[tuple[str, str], ...] = (
    ...
    ('invite_guest_patient_chart', MODULE_PATIENT_CHARTS),
    ...
    ('resend_guest_patient_chart_link', MODULE_PATIENT_CHARTS),
    ...
    ('invite_guest_health_profile', MODULE_HEALTH_PROFILE_FORMS),
    ...
    ('cancel_draft', MODULE_HEALTH_PROFILE_FORMS),
    ('resend_guest_health_form_link', MODULE_HEALTH_PROFILE_FORMS),
