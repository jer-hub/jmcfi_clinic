...
Deploy the Django/Channels app on [Railway](https://railway.com) using the repo **Dockerfile**. Postgres and file storage stay on **hosted Supabase**; Railway runs the web service and **Redis** for WebSockets.
...
## 3. Add Redis (required for messaging)
