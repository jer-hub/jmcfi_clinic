...
urlpatterns = [
    ...
    path('invite-guest/', views.invite_guest_health_profile, name='invite_guest_health_profile'),
    ...
    path('<int:pk>/cancel/', views.cancel_draft, name='cancel_draft'),
    path('<int:pk>/resend-guest-link/', views.resend_guest_health_form_link, name='resend_guest_health_form_link'),
