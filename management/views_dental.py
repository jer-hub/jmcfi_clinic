...
def dental_record_list(request):
    ...
    return render(request, 'management/dental/dental_record_list.html', context)
...
def dental_record_detail(request, record_id):
    ...
    return render(request, 'management/dental/dental_record_detail.html', context)
...
def dental_record_create(request):
    ...
    return render(request, 'management/dental/dental_record_form.html', context)
...
def dental_record_edit(request, record_id):
    ...
    return render(request, 'management/dental/dental_record_edit.html', context)
...
def dental_chart_add_tooth(request, record_id):
    ...
    if request.method == 'POST':
        ...
        if request.headers.get('HX-Request'):
            dental_chart = dental_record.dental_chart.all().order_by('tooth_number')
            return render(request, 'management/dental/partials/dental_chart_table.html', {
                'dental_chart': dental_chart,
                'dental_record': dental_record,
            })
...
def my_dental_records(request):
    ...
    return render(request, 'management/dental/my_dental_records.html', context)
...
def my_dental_record_detail(request, record_id):
    ...
    return render(request, 'management/dental/my_dental_record_detail.html', context)
