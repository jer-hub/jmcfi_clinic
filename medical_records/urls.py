...
urlpatterns = [
    ...
    path('<int:record_id>/', views.medical_record_detail_page, name='medical_record_detail_page'),
    ...
    path('create-for-patient/', views.create_medical_record_for_patient, name='create_medical_record_for_patient'),
]
